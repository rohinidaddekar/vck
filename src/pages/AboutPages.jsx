    ...
    <div className="container">
      <div id="about">
        ...
        <p className="text">
          ...
          in [Year of Establishment, e.g., 1980]. Located in the bustling heart
          of [City/Area, e.g., Chembur, Mumbai], our college has consistently
          strived to uphold the highest standards of academic rigor and ethical
          values.
        </p>
        <p className="text">
        ...
        <p className="text">
          ...
          dialogue, intellectual curiosity, and a relentless pursuit of
          knowledge.
        </p>
